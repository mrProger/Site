// Generated by dart2js (NullSafetyMode.unsound, no-legacy-javascript, csp), the Dart to JavaScript compiler version: 2.16.1.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    stringReplaceAllFuncUnchecked(receiver, pattern, onMatch, onNonMatch) {
      ...
      if (!type$.Pattern._is(pattern))
        throw A.wrapException(A.ArgumentError$value(pattern, "pattern", "is not a Pattern"));
      for (t1 = pattern.allMatches$1(0, receiver), t1 = new A._AllMatchesIterator(t1._re, t1._string, t1._start), startIndex = 0, t2 = ""; t1.moveNext$0();) {
        match = t1.__js_helper$_current;
        t3 = match._match;
        t4 = t3.index;
        t2 = t2 + A.S(A._stringIdentity(B.JSString_methods.substring$2(receiver, startIndex, t4))) + A.S(onMatch.call$1(match));
        startIndex = t4 + t3[0].length;
      }
      t1 = t2 + A.S(A._stringIdentity(B.JSString_methods.substring$1(receiver, startIndex)));
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    },
    ...
    Error_throwWithStackTrace(error, stackTrace) {
      ...
      A.ReachabilityError$(string$.x60null_);
    },
    ...
    _Uri__checkWindowsPathReservedCharacters(segments, argumentError, firstSegment) {
      var t1, t2;
      for (t1 = A.SubListIterable$(segments, firstSegment, null, A._arrayInstanceType(segments)._precomputed1), t1 = new A.ListIterator(t1, t1.get$length(t1), t1.$ti._eval$1("ListIterator<ListIterable.E>")); t1.moveNext$0();) {
        t2 = t1.__internal$_current;
        if (J.contains$1$asx(t2, A.RegExp_RegExp('["*/:<>?\\\\|]'))) {
          t1 = A.UnsupportedError$("Illegal character in path: " + t2);
          throw A.wrapException(t1);
        }
      }
    },
    ...
    _Uri__uriDecode(text, start, end, encoding, plusToSpace) {
      ...
      if (simple) {
        ...
        if (t2)
          ...
          bytes = new A.CodeUnits(t1.substring$2(text, start, end));
      } else {
    ...
    _ChildrenElementList__addAll(_element, iterable) {
      ...
      for (t1 = J.get$iterator$ax(iterable); t1.moveNext$0();)
        _element.appendChild(t1.get$current());
    },
    ...
    post(url, body) {
      return A._withClient(new A.post_closure(url, null, body, null), type$.Response);
    },
    _withClient(fn, $T) {
    ...
    MediaType$(type, subtype, parameters) {
      var t1 = type.toLowerCase(),
        ...
        t3 = type$.String;
      t3 = parameters == null ? A.LinkedHashMap_LinkedHashMap$_empty(t3, t3) : A.CaseInsensitiveMap$from(parameters, t3);
      return new A.MediaType(t1, t2, new A.UnmodifiableMapView(t3, type$.UnmodifiableMapView_String_String));
    },
    ...
    expectQuotedString(scanner) {
      ...
      return A.stringReplaceAllFuncUnchecked(B.JSString_methods.substring$2(string, 1, string.length - 1), $.$get$_quotedPair(), type$.nullable_String_Function_Match._as(type$.String_Function_Match._as(new A.expectQuotedString_closure())), type$.nullable_String_Function_String._as(null));
    },
    ...
    SourceLocation$(offset, column, line, sourceUrl) {
      ...
      return new A.SourceLocation(sourceUrl, offset, t2, column);
    },
    ...
    main() {
      var t1 = $.$get$_context();
      t1.$indexSet(0, "slideToLeft", A.script__slideToLeft$closure());
      t1.$indexSet(0, "slideToRight", A.script__slideToRight$closure());
      t1.$indexSet(0, "adminAuth", A.script__adminAuth$closure());
      t1.$indexSet(0, "setImageInSlider", A.script__setImageInSlider$closure());
      t1.$indexSet(0, "goToAdminPanel", A.script__goToAdminPanel$closure());
      t1.$indexSet(0, "checkAdminAuth", A.script__checkAdminAuth$closure());
      t1.$indexSet(0, "leaveAdminPanel", A.script__leaveAdminPanel$closure());
      t1.$indexSet(0, "createOrder", A.script__createOrder$closure());
      t1.$indexSet(0, "isTelephoneNumber", A.script__isTelephoneNumber$closure());
      t1.$indexSet(0, "isEmail", A.script__isEmail$closure());
      t1.$indexSet(0, "createDatabase", A.script__createDatabase$closure());
      t1.$indexSet(0, "viewOrders", A.script__viewOrders$closure());
    },
    slideToLeft() {
      var i, t1, t2;
      for (i = 0; i < 2; ++i) {
        t1 = $.picturesIndex;
        t2 = t1[i];
        B.JSArray_methods.$indexSet(t1, i, t2 <= 0 ? 3 : t2 - 1);
      }
      A.setImageInSlider();
    },
    slideToRight() {
      ...
      for (i = 0; i < 2; ++i) {
        t1 = $.picturesIndex;
        t2 = t1[i];
        B.JSArray_methods.$indexSet(t1, i, t2 >= 3 ? 0 : t2 + 1);
      }
      A.setImageInSlider();
    },
    setImageInSlider() {
      var i, t1, t2, t3;
      for (i = 0; t1 = $.$get$imgList(), t2 = t1._nodeList, i < t2.length; ++i) {
        t1 = A._instanceType(t1)._precomputed1._as(t2[i]);
        t2 = $.picturesList;
        t3 = $.picturesIndex;
        if (!(i < 2))
          return A.ioore(t3, i);
    ...
    adminAuth() {
      var _s8_ = "password",
        ...
        inputField = A.LinkedHashMap_LinkedHashMap$_literal(["login-field", t2._as(t1.querySelector("#admin-login-input")), "password-field", t2._as(t1.querySelector("#admin-password-input"))], t3, t2),
        inputData = A.LinkedHashMap_LinkedHashMap$_literal(["login", inputField.$index(0, "login-field").value, "password", inputField.$index(0, "password-field").value], t3, t3);
      t1 = inputData.$index(0, "login");
      t2 = J.toString$0$(t1);
      if (!(A.stringReplaceAllUnchecked(t2, " ", "") === "" || t1 == null)) {
        t1 = inputData.$index(0, _s8_);
        t2 = J.toString$0$(t1);
        t1 = !(A.stringReplaceAllUnchecked(t2, " ", "") === "" || t1 == null);
      } else
        t1 = false;
      if (t1)
        if (inputData.$index(0, "login") === "admin" && inputData.$index(0, _s8_) === "123admin123") {
          $.$get$localStorage().setItem("auth", "true");
    ...
    checkAdminAuth() {
      ...
      var $async$checkAdminAuth = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if ($.$get$localStorage().getItem("auth") == null || $.$get$localStorage().getItem("auth") !== "true")
                window.location.href = "admin-auth.html";
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$checkAdminAuth, $async$completer);
    },
    createDatabase() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic);
      var $async$createDatabase = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.get(A.Uri_parse("http://127.0.0.1:8080/ritmapi/v1/database/create"), null), $async$createDatabase);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$createDatabase, $async$completer);
    },
    leaveAdminPanel() {
      $.$get$localStorage().setItem("auth", null);
      window.location.href = "admin-auth.html";
    },
    isTelephoneNumber(number) {
      return A.isTelephoneNumber$body(A._asStringS(number));
    },
    isTelephoneNumber$body(number) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.legacy_bool),
        $async$returnValue, regExp, $async$temp1;
      var $async$isTelephoneNumber = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              regExp = A.RegExp_RegExp("(\\+7[0-9]{10})");
              number.toString;
              $async$temp1 = J;
              $async$goto = 3;
              return A._asyncAwait(A.stringReplaceAllFuncUnchecked(number, regExp, type$.nullable_String_Function_Match._as(type$.String_Function_Match._as(new A.isTelephoneNumber_closure())), type$.nullable_String_Function_String._as(null)), $async$isTelephoneNumber);
            case 3:
              // returning from await.
              if ($async$temp1.toString$0$($async$result) === "1") {
      ...
      return A._asyncStartSync($async$isTelephoneNumber, $async$completer);
    },
    isEmail(address) {
      return A.isEmail$body(A._asStringS(address));
    },
    isEmail$body(address) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.legacy_bool),
        $async$returnValue, regExp, $async$temp1;
      var $async$isEmail = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              regExp = A.RegExp_RegExp("((?:[a-z0-9!#$%&*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&*+\\/=?^_`{|}~-]+)*|(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21\\x23-\\x5b\\x5d-\\x7f]|\\\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])*)@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\\[(?:(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9]))\\.){3}(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9])|[a-z0-9-]*[a-z0-9]:(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21-\\x5a\\x53-\\x7f]|\\\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])+)\\]))");
              address.toString;
              $async$temp1 = J;
              $async$goto = 3;
              return A._asyncAwait(A.stringReplaceAllFuncUnchecked(address, regExp, type$.nullable_String_Function_Match._as(type$.String_Function_Match._as(new A.isEmail_closure())), type$.nullable_String_Function_String._as(null)), $async$isEmail);
            case 3:
              // returning from await.
              if ($async$temp1.toString$0$($async$result) === "5") {
                $async$returnValue = true;
                // goto return
                $async$goto = 1;
                break;
      ...
      return A._asyncStartSync($async$isEmail, $async$completer);
    },
    createOrder() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, t3, service, t4, t5, t6, t7, t1, t2, inputFields, inputData, $async$temp1;
      var $async$createOrder = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              inputFields = A.LinkedHashMap_LinkedHashMap$_literal(["service-input", t1.querySelector(".service-type"), "name-input", t1.querySelector(".name-input"), "telephone-input", t1.querySelector(".telephone-number-input"), "email-input", t1.querySelector(".email-input")], t2, type$.dynamic);
              inputData = A.LinkedHashMap_LinkedHashMap$_literal(["service", A._asStringS(J.get$value$x(inputFields.$index(0, "service-input"))), "name", A._asStringS(J.get$value$x(inputFields.$index(0, "name-input"))), "telephone", A._asStringS(J.get$value$x(inputFields.$index(0, "telephone-input"))), "email", A._asStringS(J.get$value$x(inputFields.$index(0, "email-input")))], t2, t2);
              t1 = inputData.$index(0, "service");
              t3 = J.toString$0$(t1);
              if (!(A.stringReplaceAllUnchecked(t3, " ", "") === "" || t1 == null)) {
                t1 = inputData.$index(0, "name");
                t3 = J.toString$0$(t1);
                if (!(A.stringReplaceAllUnchecked(t3, " ", "") === "" || t1 == null)) {
                  t1 = inputData.$index(0, "telephone");
                  t3 = J.toString$0$(t1);
                  if (!(A.stringReplaceAllUnchecked(t3, " ", "") === "" || t1 == null)) {
                    t1 = inputData.$index(0, "email");
                    t3 = J.toString$0$(t1);
                    t1 = !(A.stringReplaceAllUnchecked(t3, " ", "") === "" || t1 == null);
                  } else
                    t1 = false;
                } else
                  t1 = false;
            ...
            case 3:
              ...
              $async$temp1 = A;
              $async$goto = 6;
              return A._asyncAwait(A.isTelephoneNumber(inputData.$index(0, "telephone")), $async$createOrder);
            case 6:
              // returning from await.
              if (!$async$temp1.boolConversionCheck($async$result)) {
                B.Window_methods.alert$1(window, "\u041d\u0435\u043f\u0440\u0430\u0432\u0438\u043b\u044c\u043d\u043e \u0432\u0432\u0435\u0434\u0435\u043d \u043d\u043e\u043c\u0435\u0440 \u0442\u0435\u043b\u0435\u0444\u043e\u043d\u0430");
                // goto return
                $async$goto = 1;
                break;
              }
              $async$temp1 = A;
              $async$goto = 7;
              return A._asyncAwait(A.isEmail(inputData.$index(0, "email")), $async$createOrder);
            case 7:
              // returning from await.
              if (!$async$temp1.boolConversionCheck($async$result)) {
                B.Window_methods.alert$1(window, "\u041d\u0435\u043f\u0440\u0430\u0432\u0438\u043b\u044c\u043d\u043e \u0432\u0432\u0435\u0434\u0435\u043d \u0430\u0434\u0440\u0435\u0441 \u044d\u043b\u0435\u043a\u0442\u0440\u043e\u043d\u043d\u043e\u0439 \u043f\u043e\u0447\u0442\u044b");
                // goto return
                $async$goto = 1;
                break;
              }
              service = inputData.$index(0, "service").split(" - ");
              t1 = A.Uri_parse("http://127.0.0.1:8080/ritmapi/v1/order/createorder");
              t3 = inputData.$index(0, "name");
              t4 = inputData.$index(0, "telephone");
              t5 = inputData.$index(0, "email");
              t6 = service.length;
              if (0 >= t6) {
                $async$returnValue = A.ioore(service, 0);
                // goto return
                $async$goto = 1;
                break;
              }
              t7 = service[0];
              if (1 >= t6) {
                $async$returnValue = A.ioore(service, 1);
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = 8;
              return A._asyncAwait(A.post(t1, A.LinkedHashMap_LinkedHashMap$_literal(["name", t3, "telephoneNumber", t4, "emailAddress", t5, "service", t7, "price", service[1]], t2, t2)), $async$createOrder);
            case 8:
              // returning from await.
              $async$goto = 9;
              return A._asyncAwait(A.post(A.Uri_parse("http://127.0.0.1:8080/ritmapi/v1/email/sendmessage"), A.LinkedHashMap_LinkedHashMap$_literal(["to", inputData.$index(0, "email"), "subject", "\u0421\u0442\u0430\u0442\u0443\u0441 \u0437\u0430\u043a\u0430\u0437\u0430", "text", "\u0417\u0434\u0440\u0430\u0432\u0441\u0442\u0432\u0443\u0439\u0442\u0435! \u0412\u0430\u0448 \u0437\u0430\u043a\u0430\u0437 \u043f\u0440\u0438\u043d\u044f\u0442 \u0432 \u0440\u0430\u0431\u043e\u0442\u0443!\n\u041d\u0430\u0448 \u043c\u0430\u0441\u0442\u0435\u0440 \u0441 \u0432\u0430\u043c\u0438 \u0441\u0432\u044f\u0436\u0435\u0442\u0441\u044f\n\u0421\u0435\u0440\u0432\u0438\u0441\u043d\u044b\u0439 \u0446\u0435\u043d\u0442\u0440 \u0420\u0438\u0442\u043c\n\n\u041d\u0435 \u043e\u0442\u0432\u0435\u0447\u0430\u0439\u0442\u0435 \u043d\u0430 \u044d\u0442\u043e \u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435, \u043e\u043d\u043e \u043e\u0442\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u043e \u0441\u0438\u0441\u0442\u0435\u043c\u043e\u0439"], t2, t2)), $async$createOrder);
            case 9:
              // returning from await.
              B.Window_methods.alert$1(window, "\u0412\u044b \u0443\u0441\u043f\u0435\u0448\u043d\u043e \u043e\u0444\u043e\u0440\u043c\u0438\u043b\u0438 \u0437\u0430\u043a\u0430\u0437!");
              // goto join
              $async$goto = 4;
              break;
            case 5:
              // else
              B.Window_methods.alert$1(window, "\u0412\u0441\u0435 \u043f\u043e\u043b\u044f \u0434\u043e\u043b\u0436\u043d\u044b \u0431\u044b\u0442\u044c \u0437\u0430\u043f\u043e\u043b\u043d\u0435\u043d\u044b");
            case 4:
              // join
            case 1:
              // return
      ...
      return A._asyncStartSync($async$createOrder, $async$completer);
    },
    viewOrders() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], reqGetCountOrder, reqGetOrders, orderDataList, orderCount, orderDivTags, orderFields, i, exception, message, t1, t2, t3, t4, t5, t6, exception0, $async$exception0;
      var $async$viewOrders = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 7;
              return A._asyncAwait(A.get(A.Uri_parse("http://127.0.0.1:8080/ritmapi/v1/order/getordercount"), A.LinkedHashMap_LinkedHashMap$_literal(["content-type", "application/json"], t1, t1)), $async$viewOrders);
            case 7:
              // returning from await.
              reqGetCountOrder = $async$result;
              reqGetOrders = null;
              orderDataList = null;
              t2 = reqGetCountOrder;
              orderCount = A._asIntS(J.$index$asx(B.C_JsonCodec.decode$2$reviver(0, A.encodingForCharset(A._contentTypeForHeaders(t2.headers).parameters._map.$index(0, "charset")).decode$1(0, t2.bodyBytes), null), "count"));
              t2 = document;
              orderDivTags = A.LinkedHashMap_LinkedHashMap$_literal(["row", t2.createElement("div"), "col", t2.createElement("div"), "order", t2.createElement("div")], t1, type$.legacy_DivElement);
              orderFields = A.LinkedHashMap_LinkedHashMap$_literal(["name", t2.createElement("p"), "telephone", t2.createElement("p"), "email", t2.createElement("p"), "service", t2.createElement("p"), "price", t2.createElement("p")], t1, type$.legacy_ParagraphElement);
              i = 1;
              t3 = type$.JSArray_legacy_Element;
            ...
            case 8:
              ...
              $async$goto = 10;
              return A._asyncAwait(A.get(A.Uri_parse("http://127.0.0.1:8080/ritmapi/v1/order/getorder/id/" + A.S(i)), A.LinkedHashMap_LinkedHashMap$_literal(["content-type", "application/json"], t1, t1)), $async$viewOrders);
            case 10:
              // returning from await.
              reqGetOrders = $async$result;
              t5 = reqGetOrders;
              orderDataList = B.C_JsonCodec.decode$2$reviver(0, A.encodingForCharset(A._contentTypeForHeaders(t5.headers).parameters._map.$index(0, "charset")).decode$1(0, t5.bodyBytes), null);
              t5 = t2.createElement("div");
              t5.className = "row py-3";
              J.$indexSet$ax(orderDivTags, "row", t5);
              t5 = t2.createElement("div");
              t5.className = "col d-flex flex-column";
              J.$indexSet$ax(orderDivTags, "col", t5);
              t5 = t2.createElement("div");
              t5.className = "align-self-center order";
              J.$indexSet$ax(orderDivTags, "order", t5);
              t5 = t2.createElement("p");
              B.ParagraphElement_methods.set$text(t5, "\u041a\u0430\u043a \u043c\u043e\u0436\u043d\u043e \u043e\u0431\u0440\u0430\u0449\u0430\u0442\u044c\u0441\u044f: " + A.S(J.$index$asx(orderDataList, "name")));
              t5.className = "order__name";
              J.$indexSet$ax(orderFields, "name", t5);
              t5 = t2.createElement("p");
              B.ParagraphElement_methods.set$text(t5, "\u041d\u043e\u043c\u0435\u0440 \u0442\u0435\u043b\u0435\u0444\u043e\u043d\u0430: " + A.S(J.$index$asx(orderDataList, "telephone")));
              t5.className = "order__telephone";
              J.$indexSet$ax(orderFields, "telephone", t5);
              t5 = t2.createElement("p");
              B.ParagraphElement_methods.set$text(t5, "\u0410\u0434\u0440\u0435\u0441 \u044d\u043b.\u043f\u043e\u0447\u0442\u044b: " + A.S(J.$index$asx(orderDataList, "email")));
              t5.className = "order__email";
              J.$indexSet$ax(orderFields, "email", t5);
              t5 = t2.createElement("p");
              B.ParagraphElement_methods.set$text(t5, "\u0423\u0441\u043b\u0443\u0433\u0430: " + A.S(J.$index$asx(orderDataList, "service")));
              t5.className = "order__service";
              J.$indexSet$ax(orderFields, "service", t5);
              t5 = t2.createElement("p");
              B.ParagraphElement_methods.set$text(t5, "\u0421\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c: " + A.S(J.$index$asx(orderDataList, "price")));
              t5.className = "order__price";
              J.$indexSet$ax(orderFields, "price", t5);
              t5 = J.$index$asx(orderDivTags, "order");
              t5.children;
              A._ChildrenElementList__addAll(t5, t4._as(A._setArrayType([J.$index$asx(orderFields, "name"), J.$index$asx(orderFields, "telephone"), J.$index$asx(orderFields, "email"), J.$index$asx(orderFields, "service"), J.$index$asx(orderFields, "price")], t3)));
              t5 = J.$index$asx(orderDivTags, "col");
              t5.children;
              t5.appendChild(J.$index$asx(orderDivTags, "order"));
              t5 = J.$index$asx(orderDivTags, "row");
              t5.children;
              t5.appendChild(J.$index$asx(orderDivTags, "col"));
              J.get$children$x(t2.querySelector(".content__background")).add$1(0, J.$index$asx(orderDivTags, "row"));
              t5 = i;
              if (typeof t5 !== "number") {
            ...
            case 9:
              ...
              t1.className = "row py-3";
              J.$indexSet$ax(orderDivTags, "row", t1);
              J.get$children$x(t2.querySelector(".content__background")).add$1(0, J.$index$asx(orderDivTags, "row"));
              $async$handler = 2;
              // goto after finally
              $async$goto = 6;
            ...
            case 4:
              ...
              message = A.getTraceFromException($async$exception0);
              t1 = "\u041e\u0448\u0438\u0431\u043a\u0430: " + A.S(exception) + "\n\u0418\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044f: " + A.S(message);
      ...
      return A._asyncStartSync($async$viewOrders, $async$completer);
    },
    isTelephoneNumber_closure: function isTelephoneNumber_closure() {
    },
    isEmail_closure: function isEmail_closure() {
    },
    isBrowserObject(o) {
    ...
    isAllTheSame(iter) {
      ...
      for (t1 = A.SubListIterable$(iter, 1, null, iter.$ti._eval$1("ListIterable.E")), t1 = new A.ListIterator(t1, t1.get$length(t1), t1.$ti._eval$1("ListIterator<ListIterable.E>")); t1.moveNext$0();)
    ...
    countCodeUnits(string, codeUnit) {
      var t1, count;
      for (t1 = new A.CodeUnits(string), t1 = new A.ListIterator(t1, t1.get$length(t1), type$.CodeUnits._eval$1("ListIterator<ListMixin.E>")), count = 0; t1.moveNext$0();)
  ...
  J.JSString.prototype = {
    ...
    replaceRange$3(receiver, start, end, replacement) {
      ...
      if (!A._isInt(e))
        A.throwExpression(A.argumentErrorValue(e));
  ...
  A.CodeUnits.prototype = {
    ...
    $index(_, i) {
      return B.JSString_methods.codeUnitAt$1(this.__internal$_string, A._asIntS(i));
    }
  };
  ...
  A.Instantiation.prototype = {
    $eq(_, other) {
      if (other == null)
        return false;
      return other instanceof A.Instantiation && J.$eq$(this._genericClosure, other._genericClosure) && A.getRuntimeType(this) === A.getRuntimeType(other);
    },
    get$hashCode(_) {
  ...
  A.MapMixin_entries_closure.prototype = {
    call$1(key) {
      ...
      return new A.MapEntry(key, J.$index$asx(t1, key), t2._eval$1("@<MapMixin.K>")._bind$1(t2._eval$1("MapMixin.V"))._eval$1("MapEntry<1,2>"));
    },
    $signature() {
  ...
  A.SetMixin.prototype = {
    ...
    elementAt$1(_, index) {
      ...
      for (t1 = A._LinkedHashSetIterator$(_this, _this._collection$_modifications, _this.$ti._precomputed1), elementIndex = 0; t1.moveNext$0();) {
  ...
  A._JsonMapKeyIterable.prototype = {
    ...
    elementAt$1(_, index) {
      var t1 = this._parent;
      return t1._processed == null ? t1.get$keys(t1).elementAt$1(0, index) : B.JSArray_methods.$index(t1._computeKeys$0(), index);
    },
    get$iterator(_) {
      var t1 = this._parent;
  ...
  A._ByteCallbackSink.prototype = {
    add$1(_, chunk) {
      ...
      if (typeof t4 !== "number")
        return A.iae(t4);
      B.NativeUint8List_methods.setRange$3(t1, t2, t2 + t4, chunk);
  ...
  A._ChildrenElementList.prototype = {
    ...
    $index(_, index) {
      return type$.Element._as(J.$index$asx(this._childElements, A._asIntS(index)));
    },
    $indexSet(_, index, value) {
      A._asIntS(index);
  ...
  A._FrozenElementList.prototype = {
    ...
    $index(_, index) {
      return this.$ti._precomputed1._as(B.NodeList_methods.$index(this._nodeList, A._asIntS(index)));
    },
    $indexSet(_, index, value) {
      A._asIntS(index);
  ...
  A.HttpRequest.prototype = {
    ...
    setRequestHeader$2(receiver, $name, value) {
      return receiver.setRequestHeader(A._asStringS($name), A._asStringS(value));
    },
    $isHttpRequest: 1
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (body != null) {
                t1 = type$.String;
                t1 = type$.Map_String_String._as(body.cast$2$0(body, t1, t1));
  ...
  A.BaseRequest_closure0.prototype = {
    call$1(key) {
      return B.JSString_methods.get$hashCode(A._asStringS(key).toLowerCase());
    },
    $signature: 37
  };
  ...
  A.BrowserClient.prototype = {
    ...
    close$0(_) {
      var t1;
      for (t1 = this._xhrs, t1 = A._LinkedHashSetIterator$(t1, t1._collection$_modifications, t1.$ti._precomputed1); t1.moveNext$0();)
        t1._collection$_current.abort();
    }
  };
  A.BrowserClient_send_closure.prototype = {
    call$1(_) {
      var t1, t2, body, t3, t4, t5, t6;
      type$.ProgressEvent._as(_);
      t1 = this.xhr;
      t2 = type$.ByteBuffer._as(A._convertNativeToDart_XHR_Response(t1.response));
      t2.toString;
      body = A.NativeUint8List_NativeUint8List$view(t2, 0, null);
  ...
  A.CaseInsensitiveMap$from_closure.prototype = {
    call$1(key) {
      return A._asStringS(key).toLowerCase();
    },
    $signature: 10
  };
  ...
  A.MediaType_toString_closure.prototype = {
    call$2(attribute, value) {
      var t1, t2;
      A._asStringS(attribute);
      A._asStringS(value);
      t1 = this.buffer;
      t1._contents += "; " + A.S(attribute) + "=";
      t2 = $.$get$nonToken()._nativeRegExp;
      if (typeof value != "string")
        A.throwExpression(A.argumentErrorValue(value));
      if (t2.test(value)) {
        t1._contents += '"';
        t2 = $.$get$_escapedChar();
        value.toString;
        t2 = t1._contents += A.stringReplaceAllFuncUnchecked(value, t2, type$.nullable_String_Function_Match._as(type$.String_Function_Match._as(new A.MediaType_toString__closure())), type$.nullable_String_Function_String._as(null));
        t1._contents = t2 + '"';
      } else
        t1._contents += A.S(value);
    },
    $signature: 3
  };
  ...
  A.Context_joinAll_closure.prototype = {
    call$1(part) {
      return A._asStringS(part) !== "";
    },
    $signature: 17
  };
  A.Context_split_closure.prototype = {
    call$1(part) {
      return A._asStringS(part).length !== 0;
    },
    $signature: 17
  };
  ...
  A.SourceFile.prototype = {
    ...
    getColumn$1(offset) {
      ...
      lineStart = B.JSArray_methods.$index(_this._lineStarts, line);
      if (lineStart > offset)
        ...
        if (endOffset - _this._file$_start === 0) {
          if (endLine === t1._lineStarts.length - 1)
            ...
            if (typeof endLine !== "number")
              return endLine.$add();
            t1 = A.String_String$fromCharCodes(B.NativeUint32List_methods.sublist$2(t1._decodedChars, t2, t1.getOffset$1(endLine + 1)), 0, null);
          }
          return t1;
        }
  ...
  A.Highlighter.prototype = {
    highlight$0() {
      ...
      highlightsByColumn = A.List_List$filled(_this._maxMultilineSpans, _null, false, type$.nullable__Highlight);
      for (t2 = _this._buffer, t3 = highlightsByColumn.length !== 0, t4 = _this._primaryColor, i = 0; i < t1.length; ++i) {
        line = t1[i];
        if (i > 0) {
          lastLine = t1[i - 1];
          t5 = lastLine.url;
        ...
        for (t5 = line.highlights, t6 = A._arrayInstanceType(t5)._eval$1("ReversedListIterable<1>"), t7 = new A.ReversedListIterable(t5, t6), t6 = new A.ListIterator(t7, t7.get$length(t7), t6._eval$1("ListIterator<ListIterable.E>")), t7 = line.number, t8 = line.text, t9 = J.getInterceptor$s(t8); t6.moveNext$0();) {
    ...
    _writeArrow$3$beginning(line, column, beginning) {
      var t1 = beginning ? 0 : 1,
        t2 = this._buffer;
      t1 = t2._contents += B.JSString_methods.$mul("\u2500", 1 + column + this._countTabs$1(J.substring$2$s(line.text, 0, column + t1)) * 3);
      t2._contents = t1 + "^";
    },
    ...
    _writeText$1(text) {
      var t1, t2, t3;
      text.toString;
      t1 = new A.CodeUnits(text);
      t1 = new A.ListIterator(t1, t1.get$length(t1), type$.CodeUnits._eval$1("ListIterator<ListMixin.E>"));
      t2 = this._buffer;
      for (; t1.moveNext$0();) {
        ...
        if (t3 === 9)
          ...
          t2._contents += A.Primitives_stringFromCharCode(t3);
      }
    },
    ...
    _countTabs$1(text) {
      var t1, count;
      for (t1 = new A.CodeUnits(text), t1 = new A.ListIterator(t1, t1.get$length(t1), type$.CodeUnits._eval$1("ListIterator<ListMixin.E>")), count = 0; t1.moveNext$0();)
    ...
    _isOnlyWhitespace$1(text) {
      var t1, t2;
      for (t1 = new A.CodeUnits(text), t1 = new A.ListIterator(t1, t1.get$length(t1), type$.CodeUnits._eval$1("ListIterator<ListMixin.E>")); t1.moveNext$0();) {
        t2 = t1.__internal$_current;
        if (t2 !== 32 && t2 !== 9)
          return false;
      }
  ...
  A.Highlighter__collateLines__closure.prototype = {
    call$1(highlight) {
      var t1 = type$._Highlight._as(highlight).span.get$end().get$line(),
        t2 = this.line.number;
      if (typeof t1 !== "number")
        return t1.$lt();
      return t1 < t2;
  ...
  A._Highlight.prototype = {
    toString$0(_) {
      var t1 = this.span;
      t1 = "primary " + (A.S(t1.get$start(t1).get$line()) + ":" + t1.get$start(t1).get$column() + "-" + A.S(t1.get$end().get$line()) + ":" + t1.get$end().get$column());
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    }
  };
  ...
  A._Line.prototype = {
    toString$0(_) {
      return "" + this.number + ': "' + A.S(this.text) + '" (' + B.JSArray_methods.join$1(this.highlights, ", ") + ")";
    }
  };
  ...
  A.SourceLocationMixin.prototype = {
    ...
    toString$0(_) {
      var t1 = this.offset,
        ...
        t3 = this.file,
        source = t3.url,
        t4 = A.S(source == null ? "unknown source" : source) + ":",
        t5 = t3.getLine$1(t1);
      if (typeof t5 !== "number")
        return t5.$add();
  ...
  A.StringScannerException.prototype = {
    get$source(_) {
      return A._asStringS(this.source);
    }
  };
  ...
  A.isTelephoneNumber_closure.prototype = {
    call$1(match) {
      return "" + match.get$groupCount();
    },
    $signature: 18
  };
  A.isEmail_closure.prototype = {
    call$1(match) {
      return "" + match.get$groupCount();
    },
    $signature: 18
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 35, 0, 0);
    _instance_2_u(A._Future.prototype, "get$_completeError", "_completeError$2", 38);
    ...
    _static_2(A, "collection_ListMixin__compareAny$closure", "ListMixin__compareAny", 19);
    _static_1(A, "convert___defaultToEncodable$closure", "_defaultToEncodable", 2);
    var _;
    _instance_1_i(_ = A._ByteCallbackSink.prototype, "get$add", "add$1", 57);
    ...
    _instance_2_i(A.HttpRequest.prototype, "get$setRequestHeader", "setRequestHeader$2", 3);
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 59);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 60);
    _static_0(A, "script__slideToLeft$closure", "slideToLeft", 0);
    _static_0(A, "script__slideToRight$closure", "slideToRight", 0);
    _static_0(A, "script__setImageInSlider$closure", "setImageInSlider", 0);
    _static_0(A, "script__adminAuth$closure", "adminAuth", 0);
    _static_0(A, "script__goToAdminPanel$closure", "goToAdminPanel", 0);
    _static_0(A, "script__checkAdminAuth$closure", "checkAdminAuth", 0);
    _static_0(A, "script__createDatabase$closure", "createDatabase", 0);
    _static_0(A, "script__leaveAdminPanel$closure", "leaveAdminPanel", 0);
    _static_1(A, "script__isTelephoneNumber$closure", "isTelephoneNumber", 7);
    _static_1(A, "script__isEmail$closure", "isEmail", 7);
    _static_0(A, "script__createOrder$closure", "createOrder", 0);
    _static_0(A, "script__viewOrders$closure", "viewOrders", 4);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Iterable, A.CastIterator, A.MapMixin, A.Closure, A.Error, A._ListBase_Object_ListMixin, A.SentinelValue, A.ListIterator, A.Iterator, A.ExpandIterator, A.EmptyIterator, A.WhereTypeIterator, A.FixedLengthListMixin, A.UnmodifiableListMixin, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A._Required, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.StringMatch, A._StringAllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._StreamController, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._StreamIterator, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListMixin, A._UnmodifiableMapMixin, A.SetMixin, A.Codec, A._Base64Encoder, A.ChunkedConversionSink, A._JsonStringifier, A._Utf8Encoder, A._Utf8Decoder, A.DateTime, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.EventStreamProvider, A.ImmutableListMixin, A.FixedSizeListIterator, A._AcceptStructuredClone, A.JsObject, A.NullRejectionException, A.CanonicalizedMap, A.BaseClient, A.BaseRequest, A.BaseResponse, A.ClientException, A.MediaType, A.Context, A.Style, A.ParsedPath, A.PathException, A.SourceFile, A.SourceLocationMixin, A.SourceSpanMixin, A.Highlighter, A._Highlight, A._Line, A.SourceLocation, A.SourceSpanException, A.StringScanner]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.DataElement, A.DivElement, A.FormElement, A.InputElement, A.LIElement, A.MeterElement, A.OptionElement, A.OutputElement, A.ParagraphElement, A.ParamElement, A.ProgressElement, A.SelectElement, A.TextAreaElement]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      legacy_ParagraphElement: findType("ParagraphElement*"),
...
;
  ...
  (function staticFields() {
    ...
    $._current = null;
    $.picturesList = A._setArrayType(["view/image/img-slider1.jpg", "view/image/img-slider2.jpg", "view/image/img-slider3.jpg", "view/image/img-slider4.jpg"], type$.JSArray_legacy_String);
    $.picturesIndex = A._setArrayType([0, 1], type$.JSArray_legacy_int);
  })();
  (function lazyInitializers() {
    ...
    _lazyOld($, "imgList", "$get$imgList", () => {
      var t1 = A.document();
      A.checkTypeBound(A.findType("Element*"), type$.Element, "T", "querySelectorAll");
      return new A._FrozenElementList(t1.querySelectorAll(".slider__img"), A.findType("_FrozenElementList<Element*>"));
    });
    _lazyOld($, "localStorage", "$get$localStorage", () => A.window().localStorage);
  })();
